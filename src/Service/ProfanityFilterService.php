...
class ProfanityFilterService
{
    ...
    public function check(string $text): array
    {
        ...
        return [
            'isProfane' => (bool)($d['profanity_found'] ?? $d['isProfane'] ?? false),
            'filteredText' => (string)($d['censored_content'] ?? $d['filteredText'] ?? $text),
            'profaneWords' => isset($d['profanity_count']) ? (int)$d['profanity_count'] : (isset($d['profaneWords']) ? (int)$d['profaneWords'] : null),
            'raw' => $data,
        ];
    }
}